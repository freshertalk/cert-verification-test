...
scanQrBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    verificationResult.innerHTML =
      '<p style="color: red;">Camera access denied. Please allow camera permissions to scan QR codes.</p>';
    isScanning = false;
    setTimeout(refreshApplication, 5000);
    return;
  }
  ...
  try {
    ...
    verificationResult.innerHTML =
      '<p style="color: red;">Failed to initialize QR code scanner. Please try again.</p>';
    stopScanning();
    isScanning = false;
    setTimeout(refreshApplication, 5000);
  }
